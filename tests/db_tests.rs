...
fn test_assignment_type_stats() {
    ...
    db.insert_student("s1", "class1", "John", "Doe", "john@example.com").unwrap();
    db.insert_student("s2", "class1", "Jane", "Smith", "jane@example.com").unwrap();
    
    db.insert_assignment("a1", "class1", "Lesson 1", "lesson", None).unwrap();
    db.insert_assignment("a2", "class1", "Quiz 1", "quiz", None).unwrap();
    db.insert_assignment("a3", "class1", "Lesson 2", "lesson", None).unwrap();
    
    // Add progressions
    db.insert_progression("p1", "class1", "s1", "a1", Some(0.9), "2024-01-01T09:00:00", "2024-01-01T10:00:00", None).unwrap();
    db.insert_progression("p2", "class1", "s1", "a2", Some(0.8), "2024-01-02T09:00:00", "2024-01-02T10:00:00", None).unwrap();
    db.insert_progression("p3", "class1", "s2", "a1", Some(0.95), "2024-01-01T10:00:00", "2024-01-01T11:00:00", None).unwrap();
    ...
    // Find lesson stats
    let lesson_stats = stats.iter().find(|s| s.assignment_type == "lesson").unwrap();
...
fn test_grade_distribution() {
    ...
    // Setup
    db.insert_student("s1", "class1", "John", "Doe", "john@example.com").unwrap();
    db.insert_assignment("a1", "class1", "Test", "lesson", None).unwrap();
    
    // Add progressions with various grades
    db.insert_progression("p1", "class1", "s1", "a1", Some(0.45), "2024-01-01T09:00:00", "2024-01-01T10:00:00", None).unwrap();
    db.insert_progression("p2", "class1", "s1", "a1", Some(0.65), "2024-01-02T09:00:00", "2024-01-02T10:00:00", None).unwrap();
    db.insert_progression("p3", "class1", "s1", "a1", Some(0.85), "2024-01-03T09:00:00", "2024-01-03T10:00:00", None).unwrap();
    db.insert_progression("p4", "class1", "s1", "a1", Some(0.95), "2024-01-04T09:00:00", "2024-01-04T10:00:00", None).unwrap();
...
fn test_velocity_stats() {
    ...
    db.insert_progression("p1", "class1", "s1", "a1", Some(0.9), "2024-01-01T09:00:00", "2024-01-01T10:00:00", None).unwrap();
    db.insert_progression("p2", "class1", "s2", "a1", Some(0.8), "2024-01-02T09:00:00", "2024-01-02T10:00:00", None).unwrap();
    db.insert_progression("p3", "class1", "s1", "a1", Some(0.95), "2024-01-03T09:00:00", "2024-01-03T10:00:00", None).unwrap();
